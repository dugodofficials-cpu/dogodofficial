...
console.log(databases_1.dbConnection);
let emailService;
async function initializeServices() {
    try {
        mongoose.set('strictQuery', false);
        await mongoose.connect(databases_1.dbConnection.url, {
...
exports.default = setupOrderTemplates;
//# sourceMappingURL=setup-order-templates.js.map