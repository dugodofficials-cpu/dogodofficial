...
export declare function isPaymentProvider(value: string): value is PaymentProvider;
export declare function isPaymentChannel(value: string): value is PaymentChannel;
