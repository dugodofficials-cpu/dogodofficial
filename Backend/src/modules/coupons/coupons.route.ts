...
import { CreateCouponDto, UpdateCouponDto, ValidateCouponDto } from '@/modules/coupons/coupons.dto';
import { Routes } from '@interfaces/routes.interface';
import validationMiddleware from '@middlewares/validation.middleware';
import authMiddleware from '@middlewares/auth.middleware';
import { hasPermission as permissionMiddleware } from '@middlewares/permission.middleware';
