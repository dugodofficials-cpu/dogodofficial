...
export const useUploadAlbumCover = () => {
  const queryClient = useQueryClient();
  return useMutation<{ data: AlbumCover; message: string }, Error, FormData | { title: string; description?: string; imageUrl: string }>({
