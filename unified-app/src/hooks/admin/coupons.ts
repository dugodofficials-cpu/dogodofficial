import { UpdateCouponInput } from '@/components/admin/coupons/types';
import { createCoupon, deleteCoupon, getCouponById, getCoupons, updateCoupon } from "@/lib/admin/api/coupons";
