...
import {
  ...
  updateState,
  deleteState,
} from '@/lib/admin/api/locations';
import { LocationFilters, CreateCountryDto, UpdateCountryDto, CreateStateDto, UpdateStateDto } from '@/components/admin/locations/types';
