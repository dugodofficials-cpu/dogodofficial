...
import { TabPanel } from '@/components/admin/shop/TabPanel';
import { AddProductForm } from '@/components/admin/shop/AddProductForm';
import { InventoryList } from '@/components/admin/shop/InventoryList';
import { CreateBundleForm } from '@/components/admin/shop/CreateBundleForm';
import { CreateEbookForm } from '@/components/admin/shop/CreateEbookForm';
