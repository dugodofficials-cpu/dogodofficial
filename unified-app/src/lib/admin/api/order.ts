import { GetOrdersQueryDto, OrderResponse as ComponentOrderResponse, Order as ComponentOrder, OrderDetailResponse, PaymentStatus, OrderStatus } from '@/components/admin/orders/types';
