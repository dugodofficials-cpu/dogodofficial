...
import { Role, UserRole, Permission, PERMISSION_VALUES } from '@backend/roles/roles.interface';
import { RoleModel, UserRoleModel } from '@backend/roles/roles.model';
import { CreateRoleDto, UpdateRoleDto, AssignRoleDto } from '@backend/roles/roles.dto';
