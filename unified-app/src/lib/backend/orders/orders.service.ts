import { CreateOrderDto, UpdateDeliveryStatusDto, UpdateOrderDto, UpdateOrderStatusDto, GetOrdersQueryDto } from '@backend/orders/orders.dto';
import { DeliveryStatus, Order, OrderStatus } from '@backend/orders/orders.interface';
...
class OrderService {
  ...
  public async getUserOrders(
    ...
    const totalPages = limit === null ? 1 : Math.ceil(filteredTotal / limit);
    return {
